...
int dataset_load_mnist(const char* train_images_file, const char* train_labels_file,
     ...
     */
    printf("Pokus o nacitanie MNIST dat...\n");
    printf("Subor trenovacich obrazkov: %s\n", train_images_file);
    printf("Subor trenovacich znaciek: %s\n", train_labels_file);
    printf("Subor testovacich obrazkov: %s\n", test_images_file);
    printf("Subor testovacich znaciek: %s\n", test_labels_file);
    ...
    if(!train_images || !train_labels || !test_images || !test_labels){
        printf("Nepodarilo sa otvorit jeden alebo viac suborov:\n");
        if(!train_images){
            printf("Nepodarilo sa otvorit subor trenovacich obrazkov\n");
        }
        if(!train_labels){
            printf("Nepodarilo sa otvorit subor trenovacich znaciek\n");
        }
        if(!test_images){
            printf("Nepodarilo sa otvorit subor testovacich obrazkov\n");
        }
        if(!test_labels){
            printf("Nepodarilo sa otvorit subor testovacich znaciek\n");
        }
    ...
    printf("Uspesne otvorene vsetky subory\n");
    ...
    printf("Hlavicka trenovacich obrazkov:\n");
    printf("Magicke cislo: %d\n", train_magic);
    printf("Pocet obrazkov: %d\n", num_train);
    ...
    printf("Hlavicka trenovacich znaciek:\n");
    printf("Magicke cislo: %d\n", train_labels_magic);
    printf("Pocet znaciek: %d\n", num_train_labels);
    ...
    printf("Hlavicka testovacich obrazkov:\n");
    printf("Magicke cislo: %d\n", test_magic);
    printf("Pocet obrazkov: %d\n", num_test);
    printf("Pocet riadkov: %d\n", test_rows);
    printf("Pocet stlpcov: %d\n", test_cols);
    ...
    printf("Hlavicka testovacich znaciek:\n");
    printf("Magicke cislo: %d\n", test_labels_magic);
    printf("Pocet znaciek: %d\n", num_test_labels);
    ...
    printf("Vytvaranie datovych mnozin:\n");
    printf("Velkost trenovacej mnoziny: %d\n", train_size);
    printf("Velkost validacnej mnoziny: %d\n", val_size);
    printf("Velkost testovacej mnoziny: %d\n", num_test);
    ...
    *test_data = dataset_create(num_test, MNIST_IMAGE_SIZE, MNIST_NUM_CLASSES);
    ...
    if(!*train_data || !*val_data || !*test_data){
        printf("Nepodarilo sa vytvorit datove mnoziny\n");
        fclose(train_images);
        fclose(train_labels);
        fclose(test_images);
        fclose(test_labels);
    ...
    printf("Uspesne vytvorene datove mnoziny\n");
    ...
    printf("Uspesne nacitane vsetky MNIST data\n");
    return 0;
} 